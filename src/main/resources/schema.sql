CREATE TABLE SCORING_MONATLICHE_FINANZSITUATION_CLUSTER (
    ...
    version BIGINT,
    UNIQUE KEY uk_monatliche_scoring_id (antragsnummer, scoring_art)
);
...
CREATE TABLE SCORING_IMMOBILIEN_FINANZIERUNGS_CLUSTER (
    ...
    version BIGINT,
    UNIQUE KEY uk_immobilien_scoring_id (antragsnummer, scoring_art)
);
...
CREATE TABLE SCORING_AUSKUNFTEI_ERGEBNIS_CLUSTER (
    ...
    version BIGINT,
    UNIQUE KEY uk_auskunftei_scoring_id (antragsnummer, scoring_art)
);
...
CREATE TABLE scoring_antragsteller_cluster (
    ...
    version BIGINT,
    UNIQUE KEY uk_antragsteller_scoring_id (antragsnummer, scoring_art)
);
...
CREATE TABLE SCORING_SCORING_ERGEBNIS (
    ...
    version BIGINT,
    UNIQUE KEY uk_scoring_ergebnis_scoring_id (antragsnummer, scoring_art)
);
