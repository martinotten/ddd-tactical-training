...
public record EinkommenDetails(
    ...
    public BigDecimal gesamteinkommenBerechnen() {
        ...
        if (urlaubsgeld != null) gesamt = gesamt.add(urlaubsgeld.divide(BigDecimal.valueOf(12))); // Monatlich
        if (weihnachtsgeld != null) gesamt = gesamt.add(weihnachtsgeld.divide(BigDecimal.valueOf(12))); // Monatlich
